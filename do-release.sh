...
GOOS=linux GOARCH=arm GOARM=5 go build -mod=vendor -ldflags="$LDFLAGS" dstask/dstask.go
# upx -q dstask
mv dstask dist/dstask-linux-arm5

GOOS=linux GOARCH=amd64 go build -mod=vendor -ldflags="$LDFLAGS" dstask/dstask.go
# upx -q dstask
mv dstask dist/dstask-linux-amd64

GOOS=darwin GOARCH=amd64 go build -mod=vendor -ldflags="$LDFLAGS" dstask/dstask.go
#upx -q dstask
