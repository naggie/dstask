...
The following advanced version adds additional support for the dstask `modify` command by inserting the selected task ID
directly into the shell prompt and supports the selection of multiple task IDs at once (zsh only!):
